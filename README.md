...
**Что происходит:**
На удалённом сервере должны быть установлены Python 3 и Git. Скрипт подключится по SSH, клонирует или обновит репозиторий, установит зависимости и 3proxy, добавит недостающие конфигурации, запустит службы `systemd` и проверит выходные IPv6.
